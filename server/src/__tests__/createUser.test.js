...
describe("POST /api/user/create", () => {
  ...
  it("Should return a bad request if the user object does not have a name", (done) => {
    const testUser = {
      ...
      userType: testUserBase.userType,
    };
  ...
  it("Should return a bad request if the user object does not have a userType", (done) => {
    const testUser = {
      name: testUserBase.name,
      email: testUserBase.email,
      password: testUserBase.password,
  ...
  it("Should return a success state if a correct user is given", async () => {
    ...
    return request
      ...
      .then((response) => {
        ...
        expect(body.user.userType).toEqual(testUser.userType);
      ...
      .then((userInDb) => {
        ...
        expect(userInDb.user.userType).toEqual(testUser.userType);
      });
  });
});
